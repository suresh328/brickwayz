      ...
      <div className='main_container' id='OurPrograms'>
        <div className='about'>
          ...
          <div className="program">
            ...
            <p className='programe_para'>Our dedicated career counselors provide individualized support to help you discover your true potential. <br></br> We offer:</p>
            <h4 className='programe_offer'></h4>
            <ul>
